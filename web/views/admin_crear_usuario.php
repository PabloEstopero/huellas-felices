...
// Asegurar que $datos existe para evitar errores en la primera carga
$datos = $datos ?? [
...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container my-5 col-md-8">
        <div class="card shadow">
            <div class="card-header bg-primario text-white">
                <h3 class="mb-0 fs-5">Crear Nuevo Usuario</h3>
            </div>
            <div class="card-body">
                <?php if (!empty($error)): ?>
                ...
                <form action="index.php?seccion=usuarios-administracion&accion=crear" method="POST" novalidate>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Nombre de Usuario (Login)</label>
                            <input type="text" id="usuario" name="usuario" class="form-control" value="<?= htmlspecialchars($datos['usuario']) ?>" required>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" id="nombre" name="nombre" class="form-control" value="<?= htmlspecialchars($datos['nombre']) ?>" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Apellidos</label>
                            <input type="text" id="apellidos" name="apellidos" class="form-control" value="<?= htmlspecialchars($datos['apellidos']) ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="telefono" name="telefono" class="form-control" value="<?= htmlspecialchars($datos['telefono']) ?>">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="date" name="fecha_nacimiento" class="form-control" value="<?= htmlspecialchars($datos['fecha_nacimiento']) ?>">
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-corporativo fw-bold px-4">Guardar Nuevo Usuario</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <!-- PIE DE PÁGINA unificado con la clase corporativa -->
